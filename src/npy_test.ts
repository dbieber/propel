...
test(async function npy_load() {
  ...
  t = await npy.load(url + "src/testdata/2.npy");
  ...
  t = await npy.load(url + "src/testdata/3.npy");
  ...
  */
  t = await npy.load(url + "src/testdata/4.npy");
  ...
  */
  t = await npy.load(url + "src/testdata/uint8.npy");
